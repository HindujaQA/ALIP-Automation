...
public class ObservationTollElem {
		...
		public static final String SUBMIT_STATUS = ".alert.alert-success.submit-sucess.ng-binding";
		public static final String SUBMIT_STATUS_TXT = "Toll gate review checklist submitted successfully!";
