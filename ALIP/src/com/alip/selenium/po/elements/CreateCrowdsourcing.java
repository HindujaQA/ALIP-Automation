...
public class CreateCrowdsourcing {
	...
	public static final String OT = "#gembaUnitName[ng-model='oneTime']";
	public static final String KPI_ADD = ".btn.btn-primary.input-sm.KPI-add-btn.floatRight[ng-click='kpidetailsAdd();']";
	public static final String IB = "#projectName[ng-model='intangibleBenefits']";
