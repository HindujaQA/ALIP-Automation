package com.alip.selenium.util;
...
public class TestScriptListener implements ITestListener, ISuiteListener, IInvokedMethodListener{
	...
	*/
	...
	public void onTestFailure(ITestResult result) {
		...
		logger.log(LogStatus.FAIL, logger.addScreenCapture(Screenshot_path));
		logger.getEndedTime();
	...
	private String getScreenShot(String sSfilename){
		...
		String dest = System.getProperty("user.dir")+"\\src\\com\\alip\\selenium\\util\\Testreport\\"+sSfilename+currTime+".jpg";
	...
	public void onStart(ISuite arg0) {
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"\\src\\com\\alip\\selenium\\util\\Testreport\\testreport.html");
	...
	public void log(LogStatus pass, String string) {
		// TODO Auto-generated method stub
