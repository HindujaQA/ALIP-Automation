package com.alip.selenium.basePage;
...
public class page extends TestScriptListener {

	public static WebDriver driver = null ;
	public static WebDriverWait wait;
	public static Properties CONFG = null;
	public static Properties OR = null;
	public static ReadExcel testExcel = new ReadExcel(System.getProperty("user.dir")+"\\src\\com\\alip\\selenium\\util\\ALIP_TESTDATA.xlsx");
	...
	public page(){
		...
		if(driver==null){
			...
			String configPath = System.getProperty("user.dir")+"\\src\\com\\alip\\selenium\\config\\config.properties";
			...
			if(CONFG.getProperty("URL_HOMEPAGE").trim().toUpperCase().contains("ALIP")){
	...
	public static void getLoggerpass(String Details) {
	TestScriptListener.logger.log(LogStatus.PASS, Details);
	
	
	}
	public static void getLoggerFail(String Details) {
		TestScriptListener.logger.log(LogStatus.FAIL, Details);
